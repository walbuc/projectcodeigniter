...
<table>
	<tr>
		<td><?php echo form_label('Contraseña', $old_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('Confirmar Contraseña', $confirm_new_password['id']); ?></td>
...
<input class="btn btn-success" type="submit" name="submit" value="Cambiar contraseña">
<?php echo form_close(); ?>
</div>
</div>